  ...
  _createClass(Table, [{
    ...
    value: function pickColumnValues(columns, values, _ref14) {
      ...
      if (isArray(values)) {
        return values.map(function (v) {
          return _this37.pickColumnValues(columns, v);
        });
      }
    ...
    value: function insertModel(model) {
      ...
      return Promise.all([this.columns(), this.genKeyVal()]).then(function (_ref15) {
        ...
        model = assign({}, keyVal, _this38.attachTimestampToValues(_this38.pickColumnValues(columns, model, opFlags), opFlags));

        return _this38.newQuery().returning('*').insert(model).then(function (_ref17) {
    ...
    value: function rawUpdate(values, _ref19) {
      ...
      return this.columns().then(function (columns) {
        values = _this40.attachTimestampToValues(_this40.pickColumnValues(columns, values, opFlags), opFlags);
        ...
        if (returning === true) {
          ...
          return _this40.query().returning('*').update(values).then(function (_ref20) {
          ...
          // just use knex!
          return _this40.query().update(values);
        }
      });
    }
