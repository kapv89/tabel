...
var _relationsManyToMany = require('./relations/ManyToMany');

var _relationsManyToMany2 = _interopRequireDefault(_relationsManyToMany);
...
var Table = (function () {
  ...
  _createClass(Table, [{
    ...
    value: function where() {
      ...
      if (args.length === 1) {
        if ((0, _isUsableObject2['default'])(args[0])) {
          var _ret = (function () {
    ...
    value: function join(tableName) {
      ...
      if ((0, _lodash.isFunction)(args[0])) {
        var _ret9 = (function () {
          var joiner = args[0];
          return {
            v: _this23.joint(function (q) {
              q.join(tableName, joiner);
            }, 'join' + tableName + (0, _md52['default'])(joiner.toString()))
          };
        })();
        ...
        }, 'join' + tableName + (0, _md52['default'])(args.toString()));
      }
    }
    ...
    value: function all() {
      ...
      if (args.length === 1) {
        ...
        return this.where.apply(this, args).all();
      }
    ...
    value: function count() {
      ...
      if (args.length === 1) {
        ...
        return this.where.apply(this, args).count();
      }
    ...
    value: function batchReduce() {
      ...
      var reduceBatchN = function reduceBatchN(batchNum, batchInitialVal) {
        return _this31.fork().limit(batchSize).offset((batchNum - 1) * batchSize).all().then(function (models) {
          try {
            var batchResult = models.reduce(reducer, batchInitialVal);
    ...
    value: function attachTimestampToValues(values, _ref7) {
      var _this34 = this;
    ...
    value: function pickColumnValues(columns, values, _ref8) {
      var _this36 = this;
    ...
    value: function insertModel(model) {
      ...
      return Promise.all([this.columns(), this.genKeyVal()]).then(function (_ref9) {
        var _ref92 = _slicedToArray(_ref9, 2);

        var columns = _ref92[0];
        var keyVal = _ref92[1];

        model = (0, _lodash.assign)({}, keyVal, _this37.attachTimestampToValues(_this37.pickColumnValues(columns, model, opFlags), opFlags));

        return _this37.newQuery().returning('*').insert(model).then(function (_ref10) {
    ...
    key: 'rawUpdate',
    value: function rawUpdate(values, _ref11) {
      var _this39 = this;

      var _ref11$returning = _ref11.returning;
      var returning = _ref11$returning === undefined ? false : _ref11$returning;
      ...
      return this.columns().then(function (columns) {
        ...
        if (returning === true) {
          ...
          return _this39.query().returning('*').update(values).then(function (_ref12) {
    ...
    value: function manyToMany(related, pivot, foreignKey, otherKey) {
      ...
      return new _relationsManyToMany2['default'](this, this.table(related), this.table(pivot), foreignKey, otherKey, joiner);
    }
