  ...
  _createClass(Table, [{
    ...
    value: function insertModel(model) {
      ...
      return Promise.all([this.columns(), this.genKeyVal()]).then(function (_ref13) {
        ...
        switch (_this37.orm.knex.client.config.client) {
          case 'mysql':
            return _this37.newQuery().insert(model).then(function () {
              return _this37.fresh().find(keyVal);
            });
          default:
    ...
    value: function rawUpdate(values, _ref17) {
      ...
      var keyCondition = _ref17.keyCondition;
      ...
      return this.columns().then(function (columns) {
        ...
        if (returning === true) {
          ...
          switch (_this39.orm.knex.client.config.client) {
            case 'mysql':
              return _this39.query().update(values).then(function () {
                return _this39.fresh().whereKey(keyCondition).first();
              });
            default:
