...
var Table = function () {
  ...
  _createClass(Table, [{
    ...
    value: function forget() {
      ...
      var options = arguments.length <= 0 || arguments[0] === undefined ? { count: false } : arguments[0];
    ...
    value: function queryCacheKey(q) {
      ...
      var eagerLoadsStr = Object.keys(q._orm.eagerLoads).map(function (rel) {
        ...
        var rel = _ref11.rel;
        var constraint = _ref11.constraint;
    ...
    value: function all() {
      ...
      if (q._orm.cacheEnabled) {
        var _ret11 = function () {
          var cacheKey = _this29.queryCacheKey(q);

          return {
            v: _this29.cache.get(cacheKey, null).then(function (models) {
              if (models === null) {
                return q.then(function (models) {
                  ...
                  return _this29.cache.set(cacheKey, models, q._orm.cacheLifetime).then(function () {
                    return models;
                  });
                }).then(function (models) {
    ...
    value: function count() {
      ...
      if (q._orm.cacheEnabled) {
        var _ret12 = function () {
          var cacheKey = _this31.queryCacheKey(q);

          return {
            v: _this31.cache.get(cacheKey, null).then(function (result) {
              if (result === null) {
                return q.then(function (result) {
                  return _this31.cache.set(cacheKey, result, q._orm.cacheLifetime).then(function () {
                    return result;
                  });
    ...
    value: function rawUpdate(values, _ref19) {
      ...
      var returning = _ref19$returning === undefined ? false : _ref19$returning;
      ...
      return this.columns().then(function (columns) {
        ...
        if (returning === true) {
          ...
          return _this41.query().returning('*').update(values).then(function (_ref20) {
