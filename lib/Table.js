...
var Table = (function () {
  ...
  _createClass(Table, [{
    ...
    value: function whereKey(val) {
      if ((0, _lodash.isArray)(val)) {
        ...
        if ((0, _lodash.isArray)(this.key())) {
          if ((0, _isUsableObject2['default'])(val)) {
            val = (0, _lodash.toPlainObject)(val);
    ...
    value: function where() {
      ...
      if (args.length === 1 && (0, _isUsableObject2['default'])(args[0])) {
        var _ret = (function () {
          var conditions = (0, _lodash.toPlainObject)(args[0]);
    ...
    value: function parseEagerLoads(eagerLoads) {
      ...
      if ((0, _lodash.isArray)(eagerLoads)) {
        return this.parseEagerLoads(eagerLoads.map(function (eagerLoad) {
          if ((0, _isUsableObject2['default'])(eagerLoad)) {
            return (0, _lodash.toPlainObject)(eagerLoad);
          } else {
      ...
      return Object.keys(eagerLoads).reduce(function (allRelations, relation) {
        ...
        if (relation in eagerLoads) {
          return (0, _lodash.assign)(parsedEagerLoads, _defineProperty({}, relation, eagerLoads[relation]));
        } else {
          return (0, _lodash.assign)(parsedEagerLoads, _defineProperty({}, relation, placeHolderConstraint));
        }
      }, {});
    }
    ...
    value: function fetchResultsFromCacheOrDatabase(q) {
      ...
      if (q._orm.cacheEnabled) {
        var _ret9 = (function () {
          var key = _this24.queryCacheKey(q);

          return {
            v: _this24.cache.get(key).then(function (result) {
              if (result !== null) {
                return result;
              } else {
                return q.then(function (result) {
                  return _this24.cache(key, result, q._orm.cacheLifetime).then(function () {
                    return result;
                  });
                });
              }
    ...
    value: function processResult(result, options) {
      ...
      var _ref6 = (0, _isUsableObject2['default'])(options) ? (0, _lodash.toPlainObject)(options) : { count: false };
      ...
      if (count === true) {
      ...
      } else if ((0, _isUsableObject2['default'])(result)) {
        // processing individual model results
        result = (0, _lodash.toPlainObject)(result);
        return this.processors.model(Object.keys(result).reduce(function (processed, key) {
          if (key.indexOf('.') > -1) {
            ...
            return (0, _lodash.assign)(processed, _defineProperty({}, key, result[key]));
          }
    ...
    value: function first() {
      return this.limit(1).all().then(function (result) {
    ...
    value: function all(options) {
      ...
      var _ref7 = (0, _isUsableObject2['default'])(options) ? (0, _lodash.toPlainObject)(options) : { withDuplicates: false };

      var withDuplicates = _ref7.withDuplicates;
      ...
      return this.uncacheQueryIfNeeded(q).then(function () {
        return _this27.fetchResultsFromCacheOrDatabase(q);
    ...
    value: function count(options) {
      ...
      var _ref8 = (0, _isUsableObject2['default'])(options) ? (0, _lodash.toPlainObject)(options) : { countDuplicates: false };

      var countDuplicates = _ref8.countDuplicates;
      ...
      return this.uncacheQueryIfNeeded(q).then(function () {
        return _this28.fetchResultsFromCacheOrDatabase(q);
      }).then(function (result) {
        return _this28.processResult(result, { count: true });
      });
    }
    ...
    value: function find() {
      ...
      switch (args.length) {
        ...
        case 1:
          return (function (val) {
            if ((0, _isUsableObject2['default'])(val)) {
              return _this29.where(val).first();
            } else {
              return _this29.whereKey(val).first();
            }
      ...
      switch (args.length) {
        ...
        case 1:
          return (function (condition) {
            if ((0, _isUsableObject2['default'])(condition)) {
              return _this30.where(condition).del();
            } else {
              // else we are deleting based on a key
              return _this30.whereKey(condition).del();
            }
          }).apply(undefined, args);
        default:
    ...
    value: function attachTimestampToValues(values, _ref9) {
      var _this31 = this;
      ...
      if ((0, _lodash.isArray)(values)) {
        return values.map(function (val) {
          return _this31.attachTimestampToValues(val);
        });
      }
    ...
    value: function genKeyVal() {
      ...
      return this.newQuery().where(newKey).first().then(function (model) {
        if ((0, _isUsableObject2['default'])(model)) {
          return _this32.genKeyVal();
        } else {
          return newKey;
        }
      });
    ...
    value: function pickColumnValues(columns, values, _ref10) {
      var _this33 = this;
      ...
      if ((0, _lodash.isArray)(values)) {
        return values.map(function (v) {
          return _this33.pickColumnValues(columns, v);
        });
      }

      var keys = (0, _lodash.isArray)(this.key()) ? this.key() : [this.key];
    ...
    value: function insertModel(model) {
      ...
      return Promise.all([this.columns(), this.genKeyVal()]).then(function (_ref11) {
        ...
        model = (0, _lodash.assign)({}, keyVal, _this34.attachTimestampToValues(_this34.pickColumnValues(columns, model, opFlags), opFlags));

        return _this34.newQuery().returning('*').insert(model).then(function (_ref12) {
    ...
    value: function updateModel(model) {
      ...
      return this.columns().then(function (columns) {
        model = _this36.attachTimestampToValues(_this36.pickColumnValues(columns, model, opFlags), opFlags);

        return _this36.query().returning('*').update(model).then(function (_ref13) {
    ...
    value: function hasOne(related, foreignKey, key) {
      ...
      return new _relationsHasOne2['default'](this, this.table(related), foreignKey, key);
    }
    ...
    value: function hasMany(related, foreignKey, key) {
      ...
      return new _relationsHasMany2['default'](this, this.table(related), foreignKey, key);
    }
    ...
    value: function hasManyThrough(related, through, firstKey, secondKey) {
      return new _relationsHasManyThrough2['default'](this, this.table(related), this.table(through), firstKey, secondKey);
    }
    ...
    value: function belongsTo(related, foreignKey, otherKey) {
      ...
      return new _relationsBelongsTo2['default'](this, related, foreignKey, otherKey);
    }
    ...
    value: function belongsToMany(related, pivot, foreignKey, otherKey) {
      ...
      return new _relationsBelongsToMany2['default'](this, this.table(related), this.table(pivot), foreignKey, otherKey, joiner);
    }
    ...
    value: function morphOne(related, inverse) {
      ...
      return new _relationsMorphOne2['default'](this, related, related[inverse]());
    }
    ...
    value: function morphMany(related, inverse) {
      ...
      return new _relationsMorphMany2['default'](this, related, related[inverse]());
    }
    ...
    value: function morphTo(tables, typeField, foreignKey) {
      ...
      tables = tables.map(function (t) {
        return _this37.table(t);
      });

      return new _relationsMorphTo2['default'](this, tables, typeField, foreignKey);
    }
  }]);
