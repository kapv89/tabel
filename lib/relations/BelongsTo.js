...
var BelongsTo = (function (_Relation) {
  ...
  function BelongsTo(fromTable, toTable, foreignKey, otherKey) {
    _classCallCheck(this, BelongsTo);

    _get(Object.getPrototypeOf(BelongsTo.prototype), 'constructor', this).call(this);
    (0, _lodash.assign)(this, { fromTable: fromTable, toTable: toTable, foreignKey: foreignKey, otherKey: otherKey });
  }
  ...
  _createClass(BelongsTo, [{
    ...
    value: function getRelated() {
      ...
      if (fromModels.length === 0) {
        ...
        return this.toTable.whereIn(this.otherKey, foreignKeys);
      }
    }
  }, {
    key: 'matchModels',
