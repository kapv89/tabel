...
var HasMany = (function (_Relation) {
  ...
  function HasMany(ownerTable, toTable, foreignKey, key) {
    ...
    _get(Object.getPrototypeOf(HasMany.prototype), 'constructor', this).call(this, ownerTable);
  ...
  _createClass(HasMany, [{
    ...
    value: function matchModels() {
      ...
      return fromModels.map(function (m) {
        return (0, _lodash.assign)(m, _defineProperty({}, relationName, (0, _lodash.isArray)(keyDict[m[key]]) ? keyDict[m[key]] : []));
      });
    }
  }, {
    key: 'insert',
