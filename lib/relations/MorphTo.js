...
var MorphTo = (function (_Relation) {
  ...
  function MorphTo(fromTable, toTables, typeField, foreignKey) {
    _classCallCheck(this, MorphTo);

    _get(Object.getPrototypeOf(MorphTo.prototype), 'constructor', this).call(this);
    (0, _lodash.assign)(this, { fromTable: fromTable, toTables: toTables, typeField: typeField, foreignKey: foreignKey });
  }
  ...
  _createClass(MorphTo, [{
    ...
    value: function matchModels() {
      ...
      var tableKeyDict = relatedModels.reduce(function (dict, _ref3) {
        ...
        return (0, _lodash.assign)(dict, {
          type: models.reduce(function (keyDict, model) {
            return (0, _lodash.assign)(_defineProperty({}, model[table.key()], model));
          }, {})
        });
      }, {});
