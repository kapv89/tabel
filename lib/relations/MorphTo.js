...
var MorphTo = function (_Relation) {
  ...
  function MorphTo(ownerTable, toTables, typeField, foreignKey) {
    ...
    var _this = _possibleConstructorReturn(this, (MorphTo.__proto__ || Object.getPrototypeOf(MorphTo)).call(this, ownerTable));
  ...
  _createClass(MorphTo, [{
    ...
    value: function join(tableName) {
      var joiner = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : function () {};
